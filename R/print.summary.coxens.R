#' @title Print Method for Summary of \code{coxens} Model
#' @description This function prints a summary of the results of a \code{coxens}
#' model in a formatted and user-friendly way, including model call, number of
#' samples, number of events, log-likelihood, BIC, coefficients, and confidence
#' intervals. It also includes significance stars for p-values.
