#' @title Summary method for a \code{coxens} model
...
#' @param ... Unused.
#' @return A object of class \code{summary.coxens}, with the following
#' components:
...
#' @export
summary.coxens <- function(object, conf.int = 0.95, compressed = TRUE, ...) {
  ...
  class(summary_list) <- "summary.coxens"
  return(summary_list)
}
